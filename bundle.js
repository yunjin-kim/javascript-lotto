...
var LottoController = /*#__PURE__*/function () {
  ...
  _createClass(LottoController, [{
    ...
    value: function submitPurchaseLotto(event) {
      ...
      if (purchaseMoney > _utils_constants_js__WEBPACK_IMPORTED_MODULE_2__.LOTTO.MAX_COST) {
        this.lottoNumberInputView.cleanLottoPurchaseInput();
        return alert(_utils_constants_js__WEBPACK_IMPORTED_MODULE_2__.ERROR_MESSAGE.MORE_THAN_MAX_COST);
      }
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  height: 100vh;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\nh1 {\n  text-align: center;\n  font-weight: 600;\n  font-size: 34px;\n  line-height: 36px;\n  margin: 52px 0px 16px 0px;\n}\n\n#app {\n  width: 414px;\n  height: 727px;  \n  border: 2px solid black;\n  padding: 0px 16px;\n}\n\nlabel[for=\"purchase-money\"] {\n  font-size: 15px;\n  line-height: 24px;\n  letter-spacing: 0.5px;\n}\n\n#lotto-purchase-form > button {\n  background: #00BCD4;\n  border-radius: 4px;\n  width: 56px;\n  height: 36px;\n  padding: 6px 6px 6px 8px;\n  color: #FFFFFF;\n  font-weight: bold;\n  letter-spacing: 1.25px;\n  margin-left: 15px;\n  outline: none;\n  border: none;\n}\n\n#lotto-purchase-input {\n  height: 36px;\n  width: 294px;\n  border: 1px solid #B4B4B4;\n  box-sizing: border-box;\n  border-radius: 4px;\n  padding: 10px 5px;\n}\n\n#lotto-purchase-input::placeholder {\n  color: #8B8B8B;\n}\n\n#lotto-list {\n  display: flex;\n}\n\n.lotto-list-column {\n  flex-direction: column;\n}\n\n.lotto-wrap {\n  display: flex;\n  flex-direction: row;\n}\n\n.hidden {\n  display: none;\n}\n\n\n#lotto-purchase-result {\n  width: 100%;\n  overflow: hidden;\n  display: flex;\n  justify-content: space-between;\n  margin-top: 28px;\n}\n\n.lotto-wrap {\n  font-size: 30px;\n  margin-right: 8px;\n}\n\n.lotto-numbers {\n  font-size: 16px;\n  line-height: 38px;\n  margin-left: 6px;\n  word-spacing: 1px;\n}\n\n#lotto-toggle-wrap {\n  display: flex;\n  flex-direction: column;\n}\n\n.switch {\n  position: relative;\n  display: inline-block;\n  width: 30px;\n  height: 20px;\n  margin-top: 4px;\n  margin-left: 24px;\n}\n\n#show-lotto-toggle {\n  opacity: 0;\n  width: 0;\n  height: 0;\n}\n\n.slider {\n  position: absolute;\n  cursor: pointer;\n  top: 3px;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: #ccc;\n  -webkit-transition: .4s;\n  transition: .4s;\n}\n\n.slider:before {\n  position: absolute;\n  content: \"\";\n  height: 13px;\n  width: 13px;\n  left: 4px;\n  bottom: 2px;\n  background-color: white;\n  -webkit-transition: .4s;\n  transition: .4s;\n}\n\ninput:checked + .slider {\n  background-color: #2196F3;\n}\n\ninput:focus + .slider {\n  box-shadow: 0 0 1px #2196F3;\n}\n\ninput:checked + .slider:before {\n  -webkit-transform: translateX(26px);\n  -ms-transform: translateX(26px);\n  transform: translateX(10px);\n}\n\n.slider.round {\n  border-radius: 34px;\n}\n\n.slider.round:before {\n  border-radius: 50%;\n}\n", "",{"version":3,"sources":["webpack://./src/css/index.css"],"names":[],"mappings":"AAEA;EACE,aAAa;EACb,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,kBAAkB;EAClB,gBAAgB;EAChB,eAAe;EACf,iBAAiB;EACjB,yBAAyB;AAC3B;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,iBAAiB;EACjB,qBAAqB;AACvB;;AAEA;EACE,mBAAmB;EACnB,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,wBAAwB;EACxB,cAAc;EACd,iBAAiB;EACjB,sBAAsB;EACtB,iBAAiB;EACjB,aAAa;EACb,YAAY;AACd;;AAEA;EACE,YAAY;EACZ,YAAY;EACZ,yBAAyB;EACzB,sBAAsB;EACtB,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,aAAa;AACf;;;AAGA;EACE,WAAW;EACX,gBAAgB;EAChB,aAAa;EACb,8BAA8B;EAC9B,gBAAgB;AAClB;;AAEA;EACE,eAAe;EACf,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,iBAAiB;EACjB,gBAAgB;EAChB,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,kBAAkB;EAClB,qBAAqB;EACrB,WAAW;EACX,YAAY;EACZ,eAAe;EACf,iBAAiB;AACnB;;AAEA;EACE,UAAU;EACV,QAAQ;EACR,SAAS;AACX;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,QAAQ;EACR,OAAO;EACP,QAAQ;EACR,SAAS;EACT,sBAAsB;EACtB,uBAAuB;EACvB,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,WAAW;EACX,SAAS;EACT,WAAW;EACX,uBAAuB;EACvB,uBAAuB;EACvB,eAAe;AACjB;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,2BAA2B;AAC7B;;AAEA;EACE,mCAAmC;EACnC,+BAA+B;EAC/B,2BAA2B;AAC7B;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,kBAAkB;AACpB","sourcesContent":["@import url('reset.css');\n\nbody {\n  height: 100vh;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\nh1 {\n  text-align: center;\n  font-weight: 600;\n  font-size: 34px;\n  line-height: 36px;\n  margin: 52px 0px 16px 0px;\n}\n\n#app {\n  width: 414px;\n  height: 727px;  \n  border: 2px solid black;\n  padding: 0px 16px;\n}\n\nlabel[for=\"purchase-money\"] {\n  font-size: 15px;\n  line-height: 24px;\n  letter-spacing: 0.5px;\n}\n\n#lotto-purchase-form > button {\n  background: #00BCD4;\n  border-radius: 4px;\n  width: 56px;\n  height: 36px;\n  padding: 6px 6px 6px 8px;\n  color: #FFFFFF;\n  font-weight: bold;\n  letter-spacing: 1.25px;\n  margin-left: 15px;\n  outline: none;\n  border: none;\n}\n\n#lotto-purchase-input {\n  height: 36px;\n  width: 294px;\n  border: 1px solid #B4B4B4;\n  box-sizing: border-box;\n  border-radius: 4px;\n  padding: 10px 5px;\n}\n\n#lotto-purchase-input::placeholder {\n  color: #8B8B8B;\n}\n\n#lotto-list {\n  display: flex;\n}\n\n.lotto-list-column {\n  flex-direction: column;\n}\n\n.lotto-wrap {\n  display: flex;\n  flex-direction: row;\n}\n\n.hidden {\n  display: none;\n}\n\n\n#lotto-purchase-result {\n  width: 100%;\n  overflow: hidden;\n  display: flex;\n  justify-content: space-between;\n  margin-top: 28px;\n}\n\n.lotto-wrap {\n  font-size: 30px;\n  margin-right: 8px;\n}\n\n.lotto-numbers {\n  font-size: 16px;\n  line-height: 38px;\n  margin-left: 6px;\n  word-spacing: 1px;\n}\n\n#lotto-toggle-wrap {\n  display: flex;\n  flex-direction: column;\n}\n\n.switch {\n  position: relative;\n  display: inline-block;\n  width: 30px;\n  height: 20px;\n  margin-top: 4px;\n  margin-left: 24px;\n}\n\n#show-lotto-toggle {\n  opacity: 0;\n  width: 0;\n  height: 0;\n}\n\n.slider {\n  position: absolute;\n  cursor: pointer;\n  top: 3px;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: #ccc;\n  -webkit-transition: .4s;\n  transition: .4s;\n}\n\n.slider:before {\n  position: absolute;\n  content: \"\";\n  height: 13px;\n  width: 13px;\n  left: 4px;\n  bottom: 2px;\n  background-color: white;\n  -webkit-transition: .4s;\n  transition: .4s;\n}\n\ninput:checked + .slider {\n  background-color: #2196F3;\n}\n\ninput:focus + .slider {\n  box-shadow: 0 0 1px #2196F3;\n}\n\ninput:checked + .slider:before {\n  -webkit-transform: translateX(26px);\n  -ms-transform: translateX(26px);\n  transform: translateX(10px);\n}\n\n.slider.round {\n  border-radius: 34px;\n}\n\n.slider.round:before {\n  border-radius: 50%;\n}\n"],"sourceRoot":""}]);
// Exports
